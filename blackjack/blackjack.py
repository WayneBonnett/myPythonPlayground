...
def main():
    print('''Blackjack
          ...
          On the first play you can (D)ouble down to double your bet
          but you must (H)it one more time before (S)tanding.
          
          The dealer stops betting after hitting 17 or above
          If there is a tie, the bet is returned to the player.
